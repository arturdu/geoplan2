...
const statCards = computed(() => [
  ...
  {
    title: 'Wykonane ten miesiąc',
    stats: String(completedThisMonth.value),
    icon: 'tabler-circle-check',
    color: 'success',
    trend: '+8%',
    trendUp: true,
    subtitle: 'zamknięte zlecenia',
  },
])
...
const chartOptions = computed(() => {
  ...
  return {
    ...
    tooltip: {
      shared: true,
      y: { formatter: (val: number) => `${val} zleceń` },
    },
  }
})
...
const chartSeries = computed(() => [
  ...
  { name: 'Oczekujące / W toku', data: monthlyPending.value },
])
      ...
      >
        <VCard class="h-100">
          <VCardItem>
            ...
            <VCardTitle>Mapa projektów i geodetów</VCardTitle>
            <VCardSubtitle>{{ activeProjectLocations.length }} projektów &bull; {{ surveyorsWithLocation.length }} geodetów w terenie</VCardSubtitle>
          </VCardItem>
          <VCardText>
            <!-- Legend -->
            ...
            <template v-if="mapLoadError">
              <VAlert
                ...
                class="mb-4"
              >
                Nie udało się załadować mapy. Lista projektów poniżej:
              </VAlert>
              <VList>
                <VListItem
      ...
      >
        <VCard class="h-100 d-flex flex-column">
          <VCardItem>
            ...
            <VCardSubtitle>Kliknij aby przejść na mapie</VCardSubtitle>
          </VCardItem>
      ...
      <VCol cols="12">
        <VCard>
          <VCardItem>
            ...
            <VCardTitle>Postęp zleceń</VCardTitle>
            <VCardSubtitle>Postęp realizacji na aktywnych projektach</VCardSubtitle>
          </VCardItem>
          <VCardText>
            <VRow>
              <VCol
      ...
      <VCol cols="12">
        <VCard class="d-flex flex-column">
          <VCardItem>
            ...
            <VCardSubtitle>Wykonane vs oczekujące</VCardSubtitle>
          </VCardItem>
      ...
      <VCol cols="12">
        <VCard>
          <VCardItem>
            ...
            <VCardSubtitle>Aktualności zespołu</VCardSubtitle>
          </VCardItem>
          <VCardText>
            <VRow>
              <VCol
